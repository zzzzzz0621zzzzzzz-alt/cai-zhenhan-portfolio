...
const hotspots: Hotspot[] = [
  ...
  { page: 5, href: 'https://weixin.qq.com/sph/Aj7qnExIjH', rect: [.055,.335,.215,.82], label: '2026多彩乡村参赛规则' },
  { page: 5, href: 'https://weixin.qq.com/sph/AYjAmUHvKH', rect: [.22,.405,.385,.87], label: '2026多彩乡村｜我的村志我来修' },
  { page: 5, href: 'https://weixin.qq.com/sph/Ao6e4B0vJh', rect: [.415,.33,.595,.82], label: '贵州大山里藏着一条航空生产线？' },
  { page: 5, href: 'https://weixin.qq.com/sph/A99Uieyo2X', rect: [.61,.39,.73,.79], label: '非遗｜苗族蜡染：蓝白间的清凉' },
  { page: 5, href: 'https://weixin.qq.com/sph/A81hipZoiV', rect: [.74,.405,.85,.79], label: '下一站，地戏' },
  { page: 5, href: 'https://weixin.qq.com/sph/A0YViyFRKv', rect: [.865,.405,.975,.79], label: '晴雨皆宜｜“我在平坝等你”' },
